...
<body>
  ...
  <ul>
    <li>
      <a href="/getAllMovie">Get All Movies</a>
    </li>
    <li>
      <a href="/getMovie">Get a Movie</a>
    </li>
    <li>
      <a href="/updateMovie">Update a Movie</a>
    </li>
    <li>
      <a href="/deleteMovie">Delete a Movie</a>
    </li>
    <li>
      <a href="/deleteAllMovie">Delete All Movies</a>
    </li>
  </ul>
  <p>
    <a href="/">Logout</a>
    ...
    Record.find({}, (err, movies) => {
      if (err) {
        ...
        body {
          ...
          ${movieList}
          <h4>
          <button type="button" onclick="window.location.href='/homepage'" style="padding: 5px 10px; background-color: #333; color: #fff; border: none; border-radius: 4px; cursor: pointer;">Home</button>
          </h4>
        `;
...
<body>
  ...
  if (!title) {
    const content = `
      <h2>
      Insert a movie title and get the descriptions
      </h2>
      ${form}
    `;
...
<body>
  ...
  <p><button type="button" onclick="window.location.href='/homepage'" style="padding: 5px 10px; background-color: #333; color: #fff; border: none; border-radius: 4px; cursor: pointer;">Home</button>
  </p>
  <p><button type="button" onclick="window.location.href='/getMovie'" style="padding: 5px 10px; background-color: #333; color: #fff; border: none; border-radius: 4px; cursor: pointer;">Add another movie</button>
  </p>
  ...
  if (!title) {
    ...
    Record.findOneAndUpdate(
      ...
      (err, updatedMovie) => {
        ...
        <body>
          <h2>Movie Updated</h2>
          <p>Title:<b> ${updatedMovie.movieTitle}</b></p>
          <p>Director:<b> ${updatedMovie.movieDirector}</b></p>
          <p>Year:<b> ${updatedMovie.movieYear}</b></p>
...
<body>
  <p>Movie named <b>${title}</b> has been deleted</p>
  <p>
...
app.get('/', (req, res) => {
  ...
  <form action="/login" method="POST">
    ...
    <input type="text" id="username" name="username" style="padding: 5px; width: 200px; border: 1px solid #ccc; border-radius: 4px; margin-bottom: 10px;" />
    <br />
    <label for="password" style="display: block; margin-bottom: 10px;">Password:</label>
    <input type="password" id="password" name="password" style="padding: 5px; width: 200px; border: 1px solid #ccc; border-radius: 4px; margin-bottom: 10px;" />
    <br />
    ...
    <p style="margin-top: 10px;">Don't have an account? Click here to register now
      <button type="button" onclick="window.location.href='/register'" style="padding: 5px 10px; background-color: #333; color: #fff; border: none; border-radius: 4px; cursor: pointer;">Register</button>
    </p>
  </form>
</center>
  `);
...
app.get('/register', (req, res) => {
  ...
  <form action="/register" method="POST">
    ...
    <p style="margin-top: 10px;">Already have an account? Click here to login now
      <button type="button" onclick="window.location.href='/'" style="padding: 5px 10px; background-color: #333; color: #fff; border: none; border-radius: 4px; cursor: pointer;">Login</button>
    </p>
  </form>
</center>
